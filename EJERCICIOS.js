...
// (24) -> Multiplicacion de digitos de un string
let input = "485125468452154"; output = 1545122;
// (25) -> OPERAR A LOS USUARIOS QUE TENGAN ID IMPAR -> RESTAR LATITUD CON SU LONGITUD -> SUMAR EL RESULTADO DE LA DIFERENCIA DE CADA USUARIO
let input = [
    {
        "id": 1,
        "name": "Leanne Graham",
